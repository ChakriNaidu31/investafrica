  ...
  return (
    <div className="container-fluid">
      ...
      <div className="col-12 ready text-center py-5">
          ...
          <p className="text-white mt-4">Invest in the future of Africa by signing up today!</p>
...
<p className="copy mt-4">Copyright ©2023 Invest Africa. All rights reserved.</p>
           </div>
          </div>
        </div>
        </div>
